                        ...
                        <div class="card-body">
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="{{(!empty($adminData->avatar) ? url('upload/admin_images/' . $adminData->avatar) : url('upload/no_image.jpg')) }}"
                                        class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">

                                    <div class="overflow-hidden ms-4">
                                        <h4 class="m-0 text-dark fs-20">{{$adminData->name}}</h4>
                                        <p class="my-1 text-muted fs-16">{{$adminData->email}}</p>
                                        <p class="text-muted mb-0">Joined on {{date('d M Y', strtotime($adminData->created_at))}}</p>
                                            ...
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <input class="form-control" type="text" value="{{$adminData->username}}" readonly>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    ...
                                                                    value="{{ $adminData->phone ?? '1234567890' }}" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <img id="showImage" class="rounded avatar-lg"
                                                                src="{{(!empty($adminData->avatar) ? url('upload/admin_images/' . $adminData->avatar) : url('upload/no_image.jpg')) }}"
                                                                alt="Profile Image">
                                                        </div>
                                                    </div>
